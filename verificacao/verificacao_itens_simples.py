...
def verificar_itens_simples(ncm_entry, combo_desembolso, entry_cfop_widgets, entry_cst_widgets, checar_interrupcao_callback, clicar_rateio_callback, vars_uso_consumo=None, velocidade=0.2):
    py.PAUSE = velocidade
